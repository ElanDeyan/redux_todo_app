...
class $TodosTable extends Todos with TableInfo<$TodosTable, TodoTable> {
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<TodoTable> instance,
  ...
  @override
  TodoTable map(Map<String, dynamic> data, {String? tablePrefix}) {
...
class TodoTable extends DataClass implements Insertable<TodoTable> {
  final int? id;
  final String title;
  ...
  TodoTable copyWithCompanion(TodosCompanion data) {
    return TodoTable(
...
class TodosCompanion extends UpdateCompanion<TodoTable> {
  final Value<int?> id;
  ...
  static Insertable<TodoTable> custom({
    Expression<int>? id,
...
class $$TodosTableTableManager extends RootTableManager<
    ...
    (TodoTable, BaseReferences<_$AppDatabase, $TodosTable, TodoTable>),
    TodoTable,
